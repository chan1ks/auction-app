...
function getProductById(productId) {
    return exports.products.filter(function (p) { return p.id === productId; })[0];
}
exports.getProductById = getProductById;
function getReviewsByProductId(productId) {
    return exports.reviews.filter(function (r) { return r.productId === productId; });
}
